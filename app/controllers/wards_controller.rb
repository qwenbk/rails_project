class WardsController < ApplicationController
  ...
  private
    ...
    def ward_params
      params.require(:ward).permit(:floor, :number, :departmen, :capacity,
      hospital_stay_lists_attributes: [:id, :_destroy, :patient_id, :receipt_date, :reason, :discharge_date, :discharge_epicrisis, :ward_id,])
    end
end
